...
public class LanguageCanvasSignOn
{
    ...
    [SerializeField] protected string titleCanvasSignOn;
    ...
    /// </summary>
    public void ChangeLanguageCanvasSignOn()
    {
        _goManager.m_goCanvasSignOn.m_tmpTitleCanvasSignOn.text = titleCanvasSignOn;
        _goManager.m_goCanvasSignOn.m_tmpPHInputPseudoCanvasSignOn.text = txtPHInputPseudoCanvasSignOn;
        _goManager.m_goCanvasSignOn.m_tmpPHInputPasswordCanvasSignOn.text = txtPHInputPasswordCanvasSignOn;
        _goManager.m_goCanvasSignOn.m_tmpPHInputEmailCanvasSignOn.text = txtPHInputEmailCanvasSignOn;
        _goManager.m_goCanvasSignOn.m_tmpPHInputFirstNameCanvasSignOn.text = txtPHInputFirstNameCanvasSignOn;
        _goManager.m_goCanvasSignOn.m_tmpPHInputLastNameCanvasSignOn.text = txtPHInputLastNameCanvasSignOn;
