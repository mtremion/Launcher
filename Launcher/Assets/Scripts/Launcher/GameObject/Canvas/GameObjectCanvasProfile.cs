...
public class GameObjectCanvasProfile
{
    ...
    [SerializeField] GameObject goImgBackPersonnalsInformationsCanvasProfile;
    [Tooltip("Background of part text Personals Informations.")]
    [SerializeField] GameObject goImgBackTxtPersonnalsInformationsCanvasProfile;
    [Tooltip("Text Personals Informations.")]
    [SerializeField] GameObject goTxtPersonnalsInformationsCanvasProfile;
    [Tooltip("Text Pseudo.")]
    [SerializeField] GameObject goTxtPseudoCanvasProfile;
    [Tooltip("Text Last Name.")]
    [SerializeField] GameObject goTxtLastNameCanvasProfile;
    [Tooltip("Text First Name.")]
    [SerializeField] GameObject goTxtFirstNameCanvasProfile;
    [Tooltip("Text Email.")]
    [SerializeField] GameObject goTxtEmailCanvasProfile;
    [Tooltip("Imgage Profile.")]
    [SerializeField] GameObject goImgProfileCanvasProfile;
    [Tooltip("Button Change Profile.")]
    [SerializeField] GameObject goBtnChangeProfileCanvasProfile;
    [Tooltip("Text Button Change Profile.")]
    [SerializeField] GameObject goTxtBtnChangeProfileCanvasProfile;
    [Header("Canvas Profile / Change Password")]
    [Tooltip("Background of part Change Password.")]
    [SerializeField] GameObject goImgBackChangePasswordCanvasProfile;
    [Tooltip("Background of part text Change Password.")]
    [SerializeField] GameObject goImgBackTxtChangePasswordCanvasProfile;
    [Tooltip("Text Change Password.")]
    [SerializeField] GameObject goTxtChangePasswordCanvasProfile;
    [Tooltip("Input New Password.")]
    [SerializeField] GameObject goInputNewPasswordCanvasProfile;
    [Tooltip("Text Placeholder Input New Password.")]
    [SerializeField] GameObject goTxtPHInputNewPasswordCanvasProfile;
    [Tooltip("Text Input New Password.")]
    [SerializeField] GameObject goTxtInputNewPasswordCanvasProfile;
    [Tooltip("Button Visibility New Password.")]
    [SerializeField] GameObject goBtnVisibilityNewPasswordCanvasProfile;
    [Tooltip("Input Confirm Password.")]
    [SerializeField] GameObject goInputConfirmPasswordCanvasProfile;
    [Tooltip("Text Placeholder Input Confirm Password.")]
    [SerializeField] GameObject goTxtPHInputConfirmPasswordCanvasProfile;
    [Tooltip("Text Input Confirm Password.")]
    [SerializeField] GameObject goTxtInputConfirmPasswordCanvasProfile;
    [Tooltip("Button Visibility Confirm Password.")]
    [SerializeField] GameObject goBtnVisibilityConfirmPasswordCanvasProfile;
    [Tooltip("Text info Passwords.")]
    [SerializeField] GameObject goTxtInfoPasswordsCanvasProfile;
    [Tooltip("Button Change Password.")]
    [SerializeField] GameObject goBtnChangePasswordCanvasProfile;
    [Tooltip("Text Button Change Password.")]
    [SerializeField] GameObject goTxtBtnChangePasswordCanvasProfile;
    [Tooltip("PopUp Change Password.")]
    [SerializeField] GameObject goPopUpChangePasswordCanvasProfile;
    [Tooltip("Image PopUp Change Password.")]
    [SerializeField] GameObject goImgPopUpChangePasswordCanvasProfile;
    [Tooltip("Text PopUp Change Password.")]
    [SerializeField] GameObject goTxtPopUpChangePasswordCanvasProfile;
    [Tooltip("Button Ok PopUp Change Password.")]
    [SerializeField] GameObject goBtnOkPopUpChangePasswordCanvasProfile;
    [Tooltip("Text Button Ok PopUp Change Password.")]
    [SerializeField] GameObject goTxtBtnOkPopUpChangePasswordCanvasProfile;
    [Header("Canvas Profile / Delete Account")]
    [Tooltip("Background of part Delete Account.")]
    [SerializeField] GameObject goImgBackDeleteAccountCanvasProfile;
    [Tooltip("Background of part text Delete Account.")]
    [SerializeField] GameObject goImgBackTxtDeleteAccountCanvasProfile;
    [Tooltip("Text Delete Account.")]
    [SerializeField] GameObject goTxtDeleteAccountCanvasProfile;
    [Tooltip("Button Delete PopUp Change Password.")]
    [SerializeField] GameObject goBtnDeleteAccountCanvasProfile;
    [Tooltip("Text Button Ok PopUp Change Password.")]
    [SerializeField] GameObject goTxtBtnDeleteAccountPasswordCanvasProfile;
    [Tooltip("PopUp Delete Account.")]
    [SerializeField] GameObject goPopUpDeleteAccountCanvasProfile;
    [Tooltip("Image PopUp Delete Account.")]
    [SerializeField] GameObject goImgPopUpDeleteAccountCanvasProfile;
    [Tooltip("Text PopUp Delete Account.")]
    [SerializeField] GameObject goTxtPopUpDeleteAccountCanvasProfile;
    [Tooltip("Button Yes PopUp Delete Account.")]
    [SerializeField] GameObject goBtnYesPopUpDeleteAccountCanvasProfile;
    [Tooltip("Text Button Yes PopUp Delete Account.")]
    [SerializeField] GameObject goTxtBtnYesPopUpDeleteAccountCanvasProfile;
    [Tooltip("Button Cancel PopUp Delete Account.")]
    [SerializeField] GameObject goBtnCancelPopUpDeleteAccountCanvasProfile;
    [Tooltip("Text Button Cancel PopUp Delete Account.")]
    [SerializeField] GameObject goTxtBtnCancelPopUpDeleteAccountCanvasProfile;
    #endregion
